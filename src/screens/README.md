...
- `LoginScreen.tsx`: inicio de sesión y registro demo o real según entorno.
- `MarketScreen.tsx`: lista de activos, selector CLP/USD, gráfico de historial y actualizaciones realtime en modo backend.
...
- `UserScreen.tsx`: perfil, selector de tema, modo de datos y cierre de sesión.
